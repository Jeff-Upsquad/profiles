 ...
 *
 * Note: Partner Program and Jobs are views of the same `talents` module
 * (filtered by ?type=), so they share one slug.
 */
...
export type ModuleNavItem = ModuleNavLink | ModuleNavGroup;
