 ...
 * Replaces the old bottom user strip (name / email / logout).
 */
      ...
      <div className="flex items-center justify-between gap-3">
        ...
        <div className="relative">
          <button
            ...
            aria-haspopup="menu"
            onClick={() => setOpen((v) => !v)}
            className="flex h-9 w-9 items-center justify-center rounded-full bg-[#0a0a0a] text-[12px] font-semibold text-white ring-2 ring-white shadow-sm transition active:scale-95"
          >
            {initials}
          </button>
          ...
          {open && (
            ...
            >
              <div className="border-b border-[#E7E7EA] px-3.5 py-3">
                ...
                {displayPhone && (
                  <p className="truncate text-[12px] text-[#a3a3a3]">{displayPhone}</p>
                )}
              </div>
              <Link
