    ...
    <div id="field-password" className="card-saas mt-5 px-6 py-9 sm:mt-6 sm:px-10 sm:py-11">
      <div className="grid grid-cols-1 gap-x-12 gap-y-7 lg:grid-cols-[260px_1fr]">
        ...
        <div className="space-y-5">
          <Input label="Password" type="password" required value={password} onChange={(e) => onPasswordChange(e.target.value)} />
          <Input label="Confirm password" type="password" required value={confirmPassword} onChange={(e) => onConfirmPasswordChange(e.target.value)} />
