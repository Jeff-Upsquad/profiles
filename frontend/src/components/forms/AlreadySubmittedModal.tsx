...
export default function AlreadySubmittedModal({ open, onClose }: Props) {
  return (
    <Modal open={open} onClose={onClose} title="Already submitted">
      <div className="space-y-4 text-sm text-neutral-700">
        <p>
          You have already submitted a request with us. Contact Talent Support to
          know more.
        </p>
        <a
          href={WHATSAPP_URL}
          ...
          className="inline-flex w-full items-center justify-center gap-2 rounded-lg bg-[#25D366] px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-[#1ebe57] focus:outline-none focus:ring-2 focus:ring-[#25D366] focus:ring-offset-2"
        >
          <svg
            className="h-5 w-5"
            viewBox="0 0 24 24"
          ...
          WhatsApp Talent Support ({SUPPORT_PHONE_DISPLAY})
        </a>
      </div>
    </Modal>
  );
