      ...
      return (
        <div className="w-full">
          ...
          <textarea
            ...
            disabled={disabled}
            maxLength={validation_rules?.max_length}
            className={`block w-full rounded-lg border px-3 py-2 text-sm shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0a0a0a] ${
              error ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:border-[#0a0a0a]'
            }`}
          />
        ...
        <div className="w-full">
          ...
          <div className="relative">
            ...
            <input
              ...
              min={validation_rules?.min}
              max={validation_rules?.max}
              className={`block w-full rounded-lg border py-2 pl-7 pr-3 text-sm shadow-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#0a0a0a] ${
                error ? 'border-red-300 focus:ring-red-500' : 'border-gray-300 focus:border-[#0a0a0a]'
              }`}
            />
          </div>
