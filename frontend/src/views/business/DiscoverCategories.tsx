            ...
            return (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  {cat.description ? (
                    <p className="mt-1.5 font-[family-name:var(--font-inter)] text-sm text-[#838383] line-clamp-2">
                      {cat.description}
                    </p>
                  ) : (
                    <p className="mt-1.5 font-[family-name:var(--font-inter)] text-sm text-[#A1A1AA]">
                      Browse approved {cat.name.toLowerCase()} profiles
                    </p>
                  )}

                  <div className="mt-auto pt-4 inline-flex items-center gap-1 text-[13px] font-semibold text-[#6647F0] group-hover:gap-2 transition-all">
                    Browse profiles
