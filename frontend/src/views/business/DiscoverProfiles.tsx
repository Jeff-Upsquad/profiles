          ...
          <div>
            <div className="mb-2.5 flex items-center gap-2 text-xs stagger-1">
              <Link
                ...
                className="font-[family-name:var(--font-inter)] inline-flex items-center gap-1 font-semibold text-[#737373] transition-colors hover:text-[#0a0a0a]"
              >
      ...
      <div className="rounded-2xl border border-[#E8E5DE] bg-white p-4 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
          ...
          <select
            ...
            className="rounded-lg border border-[#E8E5DE] bg-white px-3 py-2 text-sm font-medium text-[#0a0a0a] focus:border-[#0a0a0a] focus:outline-none focus:ring-2 focus:ring-[#0a0a0a]/12"
          >
        ...
        <>
                  ...
                  <div className="flex flex-1 flex-col p-5">
                    ...
                    <div className="mt-3 space-y-1 font-[family-name:var(--font-inter)] text-sm text-[#525252]">
                      ...
                      {profile.field_data?.expected_salary !== undefined && (
                        <p>
                          <span className="text-[#a3a3a3]">Salary:</span>{' '}
                          <span className="font-medium text-[#0a0a0a]">
                    ...
                    {skills.length > 0 && (
                      <div className="mt-3 flex flex-wrap gap-1">
                        {skills.slice(0, 4).map((s) => (
                          <span
                            key={s}
                            className="rounded-full bg-[#F2FCBC] px-2 py-0.5 text-[11px] font-medium text-[#0a0a0a]"
                          >
                            {s.replace(/_/g, ' ')}
                          </span>
                        ))}
          ...
          {totalPages > 1 && (
            <div className="flex items-center justify-center gap-3">
              ...
              <span className="font-[family-name:var(--font-inter)] text-sm text-[#525252]">
