...
export default function ContactSupportPage() {
  ...
  return (
    <div className="font-[family-name:var(--font-inter)]">
      ...
      <div className="mt-8 flex flex-col items-center rounded-xl border border-[#E8E5DE] bg-white p-10 text-center shadow-sm">
