...
export default function SubscriptionsPage() {
  ...
  const { data: pendingCount } = useMySubscriptionCards('pending');
    ...
    <div className="space-y-6">
      ...
      {isError && (
        <div className="flex items-start gap-3 rounded-2xl border border-red-200 bg-red-50 p-4">
          ...
          <div>
            <h3 className="font-[family-name:var(--font-jakarta)] text-sm font-semibold text-red-900">Could not load subscriptions</h3>
