...
export async function updateSquad(req: Request, res: Response, next: NextFunction) {
  try { const data = await svc.updateSquadMember(req.user!.id, req.params.memberId, req.body); res.json(data); } catch (e) { next(e); }
}
export async function deleteSquad(req: Request, res: Response, next: NextFunction) {
  try { const data = await svc.deleteSquadMember(req.user!.id, req.params.memberId); res.json(data); } catch (e) { next(e); }
}
...
export async function updateMemberProfile(req: Request, res: Response, next: NextFunction) {
  try { const data = await svc.updateMemberProfile(req.user!.id, req.params.id, req.body); res.json(data); } catch (e) { next(e); }
}
export async function deleteMemberProfile(req: Request, res: Response, next: NextFunction) {
  try { const data = await svc.deleteMemberProfile(req.user!.id, req.params.id); res.json(data); } catch (e) { next(e); }
}
...
export async function updateGeneral(req: Request, res: Response, next: NextFunction) {
  try { const data = await svc.updateGeneralPortfolio(req.user!.id, req.params.id, req.body); res.json(data); } catch (e) { next(e); }
}
export async function deleteGeneral(req: Request, res: Response, next: NextFunction) {
  try { const data = await svc.deleteGeneralPortfolio(req.user!.id, req.params.id); res.json(data); } catch (e) { next(e); }
}
...
export async function deletePortfolio(req: Request, res: Response, next: NextFunction) {
  try { const data = await svc.deletePortfolioItem(req.user!.id, req.params.itemId); res.json(data); } catch (e) { next(e); }
}
