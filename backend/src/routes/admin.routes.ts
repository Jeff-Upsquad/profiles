...
router.patch('/user-approvals/:userId/restore-cancelled', adminController.restoreCancelledUser);
...
// Squad Bot Inbox — talent chats Squad Bot handed to the team. Gated by `talents`.
